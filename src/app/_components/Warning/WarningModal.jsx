...
export default function WarningModal() {
  ...
  useEffect(() => {
    // Check sessionStorage to see if the user has already accepted
    const hasAccepted = sessionStorage.getItem('hasAcceptedWarning');
    if (hasAccepted) {
      setIsOpen(false);
    }else{
        setIsOpen(true);
  ...
  const handleAccept = () => {
    // Save agreement in sessionStorage
    sessionStorage.setItem('hasAcceptedWarning', 'true');
    setIsOpen(false);
  };
