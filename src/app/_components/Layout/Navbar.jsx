  ...
  return (
    <>
      <div className="navbar z-30 grid grid-cols-6 gap-4 sm:gap-12 fixed top-0 w-[100%] shadow-lg px-6 py-2 ">
        <div className={`col-span-6 sm:${secretKey?'col-span-2':'col-span-3'}`}>
      ...
      {secretKey &&  <div className="col-span-6 sm:col-span-2">
        ...
        <div className={`hidden ${secretKey?'col-span-2':'col-span-3'} sm:flex justify-end items-center pl-4`}>
          {!secretKey ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
